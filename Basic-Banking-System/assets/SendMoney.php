...
div#frm *{display:inline;text-transform: uppercase;}
</style>
...
<!-- <div id="frm">
  ...
  <form method="get" action="history.php"><button class="button" type="submit"><strong>History</strong></button>
  </form>
...
<ul>
  ...
  <!-- <li><a href="viewCustomers.php">View All Customer</a></li> -->
  <li><a href="SendMoney.php">Transfer Money</a></li>
  <li><a href="history.php">History</a></li>
</ul>

<h1> Account Holder: Chandrashekhar Patil</h1><br>
